...
const HouseModifyGoogleMapScreen = ({ route, navigation }) => {
  ...
  const handleRegisterLocation = () => {
    console.log('새로 수정한 주소:', address); 
    navigation.navigate('숙소정보수정', { address, region, houseId});
  };
...
export default HouseModifyGoogleMapScreen;
